    ...
    return (
        <>
            <div className="w-11/12 sm:w-3/4 lg:w-1/2 mx-auto mt-10">
                ...
                {/* Input Container */}
                <div className="flex flex-col md:flex-row bg-transparent border  rounded-xl md:rounded-full shadow-sm overflow-hidden">
                ...
                <button className="md:hidden w-full mt-4 bg-blue-600 text-white px-6 py-3 hover:bg-blue-700 transition rounded-lg font-semibold cursor-pointer">
                    Search
                </button>
